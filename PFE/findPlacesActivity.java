...
public class findPlacesActivity extends FragmentActivity implements OnMapReadyCallback , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
        LocationListener {
    ...
    private String  getUrl(double latitude,double longitude,String nearbyPlace)
    {
        ...
        googleURL.append("&key="+ "AIzaSyBhUmeKqFQTPUMn2MY-mGGtvlNB-jRe1bw");
