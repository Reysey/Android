...
public class DocteurLocalisation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docteur_localisation);


        // FILLING THE TEXTVIEW (PHARMACIE NAME)
        TextView tv = (TextView) findViewById(R.id.pl_Docname);
        tv.setText(getIntent().getSerializableExtra("PE_DocName").toString());

        pe_doc = (Docteur) getIntent().getSerializableExtra("PE_Docteur");
        Toast.makeText(this, pe_doc.getDocAddress(), Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng geol = new LatLng(pe_doc.getDocLatitude(), pe_doc.getDocLongitude());
        mMap.addMarker(new MarkerOptions().position(geol).title("Docteur: "+pe_doc.getDocName()+"."));
            ...
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ...
                    try {
                        ...
                        resolvable.startResolutionForResult(DocteurLocalisation.this, 1);
    ...
    public boolean checkGoogleServices(){
        ...
        int gs_availabilityStatus = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(DocteurLocalisation.this);
        ...
        if(gs_availabilityStatus == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(DocteurLocalisation.this, gs_availabilityStatus, 9001);
            dialog.show();
        }else{
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(DocteurLocalisation.this);
    }
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(DocteurLocalisation.this, "Unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
